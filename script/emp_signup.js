        ...
        function setDateofJoin() {
            const dateInputDOJ = document.querySelector('input[name="doj"]');
            const todayDOJ = new Date();
            const maxDateDOJ = new Date(todayDOJ);
            const minDateDOJ = new Date(todayDOJ);
        
        
            maxDateDOJ.setDate(todayDOJ.getDate()); // 8 days from today
            minDateDOJ.setDate(todayDOJ.getDate() - 365); // 8 days from today
        
            dateInputDOJ.max = maxDateDOJ.toISOString().split('T')[0];
            dateInputDOJ.min = minDateDOJ.toISOString().split('T')[0];
            
        
        
            console.log("Date range set:", dateInputDOJ.min, dateInputDOJ.max); // Debug log
        }
        ...
        function validateForm(event) {
            ...
            const dateInputDOJ = document.querySelector('input[name="doj"]');
            const selectedDateDOJ = new Date(dateInputDOJ.value);
            const maxDateDOJ = new Date(dateInputDOJ.max);
            const minDateDOJ = new Date(dateInputDOJ.min);
        
        
            if (selectedDateDOJ > maxDateDOJ) {
                event.preventDefault(); // Prevent form submission
                alert(`Employee Can't be Admitted in Upcoming dates !!!`);
            }
            if (selectedDateDOJ < minDateDOJ) {
                event.preventDefault(); // Prevent form submission
                alert(`Employee Registration is permitted within 1 year after Date of Joining !!!`);
            }
        }
