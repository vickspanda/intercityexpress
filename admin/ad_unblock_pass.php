    ...
    <div class="login_form">
        <form id="signUpForm" action="un-block_user.php" method="post" onsubmit="validateForm(event)">
            ...
            <br><br>
                ...
                <input type="text" id="userType" name="userType" value="passenger" hidden><input type="text" name="do" value="Unblock" hidden><br><br>
            </div>
            <div class="submit1">
