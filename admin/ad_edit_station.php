...
<head>
    ...
    <script src="../script/ad_edit_station.js"></script>
...
<body>
    ...
    <div class="login_form">
        <form id="signUpForm" action="add_rem_stations.php" method="post" onsubmit="validateForm(event)">
            ...
            <br><br>
                <input type="text" id="username" name="username" placeholder="Enter Station's Name" onblur="fetchStationDetails()" autofocus required>
                <br><br> <div id="usernameMessage"></div>
                <input type="text" id="stationCode" name="station_code" placeholder="Enter Station's Code" readonly><br>
                <input type="text" id="userType" name="userType" value="stations" hidden>
                <input type="text" id="do" name="do" value="EDIT" hidden><br>
                <div class="drop_down">
