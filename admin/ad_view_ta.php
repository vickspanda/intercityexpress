...
<body>
    ...
    <div class="login_form">
        <form id="signUpForm" action="ad_ta_profile.php" method="post" onsubmit="validateForm(event)">
            <div class="lbl1">
                <br><br><br>
            ...
            <br><br>
                ...
                <input type="text" id="userType" name="userType" value="travel_agent" hidden><br><br>
            </div>
            <div class="submit1">
