...
<head>
    ...
    <title>Block Travel Agent</title>
...
<body>
    ...
    <div class="login_form">
        <form id="signUpForm" action="un-block_user.php" method="post" onsubmit="validateForm(event)">
            <div class="lbl1">
                <br><br><br>
                <label>Block Travel Agent !!!</label>
            </div>
            ...
            <br><br>
                ...
                <input type="text" id="userType" name="userType" value="travel_agent" hidden><input type="text" name="do" value="Block" hidden><br><br>
            </div>
            <div class="submit1">
